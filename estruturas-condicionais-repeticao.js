...
const calcularVendas = (dia = 1) => { // Função recursiva para calcular as vendas diárias
  if (dia > 7) {
    const vendasSemana = vendasDiarias.reduce((total, vendas) => total + vendas * precoHamburguer, 0); // Calcula o total das vendas na semana
  ...
  caixaComunicacao.question(`Digite o número de hambúrgueres vendidos no dia ${dia}: `, (input) => {
